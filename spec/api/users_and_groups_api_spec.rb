...
# Unit tests for SwaggerClient::UsersAndGroupsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UsersAndGroupsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::UsersAndGroupsApi.new
  end
  ...
  describe 'test an instance of UsersAndGroupsApi' do
    it 'should create an instance of UsersAndGroupsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::UsersAndGroupsApi)
    end
  end
